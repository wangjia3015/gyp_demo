...
static char ngx_http_hello_world_string(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
static char ngx_http_hello_world_counter(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);

// Structure for the HelloWorld command
static ngx_command_t ngx_http_hello_world_commands[] = {
  {
    ngx_string("hello_string"), // The command name
    NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
    ngx_http_hello_world_string, // The command handler
    NGX_HTTP_LOC_CONF_OFFSET,
    offsetof(ngx_http_hello_loc_conf_t, hello_string),
    NULL
  },
  {
    ngx_string("hello_counter"), // The command name
    NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
    ngx_http_hello_world_counter, // The command handler
    NGX_HTTP_LOC_CONF_OFFSET,
